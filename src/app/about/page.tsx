...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="space-y-2">
        <h2 className="text-2xl font-semibold">Its Purpose</h2>
        <p className="text-muted-foreground">
          This project was created as a practice to enhance my development
          skills while building a functional and user-friendly application.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <ul className="space-y-2">
          <li>✔️ Task and project management.</li>
          <li>✔️ Intuitive and user-friendly interface.</li>
          <li>✔️ Support for multiple users and collaboration.</li>
          <li>✔️ Light and dark mode for better comfort.</li>
        </ul>
      </section>
      ...
      <section className="space-y-2">
        <h2 className="text-2xl font-semibold">Technologies In Use</h2>
        <div className="flex space-x-4">
          <Tooltip>
            ...
            <TooltipContent side="bottom">Next.js</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <svg viewBox="0 0 128 128" className="size-12">
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom">PostgreSQL</TooltipContent>
          </Tooltip>
        </div>
      </section>
